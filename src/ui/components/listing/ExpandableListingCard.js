          ...
          {props.listing?.applicants?.map((applicant) => (
            <div className="flex flex-row w-full justify-between">
              <div class="flex flex-row w-full gap-4">
                ...
                <p className="text-sm">{applicant.firstname}</p>
                <p className="text-sm">{applicant.lastname}</p>
              </div>

              <div className="flex flex-row gap-3">
                <a
                  href={"/profile/" + applicant.applicantId}
                  class=" font-bold text-secondary bg-white focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-3 hover:underline focus:outline-none dark:focus:ring-blue-800"
                >
                  See Profile
                </a>
                ...
                <button
                  type="button"
                  class=" font-bold text-white bg-primary hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-3 focus:outline-none dark:focus:ring-blue-800"
                >
                  Actions
                </button>
